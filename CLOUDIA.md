# CLOUDIA.md - CloudFramework PHP8 Guide for Claude AI

This file provides instructions to Claude Code (claude.ai/code) for projects using `cloudframework-io/backend-core-php8`.

**Usage:** Add to your project's CLAUDE.md: `Follow instructions in vendor/cloudframework-io/backend-core-php8/CLOUDIA.md`

---

## Framework Overview

CloudFramework PHP8 is a backend framework for REST APIs and scripts optimized for Google Cloud Platform.
...
- **Base Classes:** `RESTful` for APIs, `Scripts2020` for scripts
