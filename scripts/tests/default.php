...
class Script extends CoreScripts
{
    ...
    {
        $this->sendTerminal("Executing {$this->params[0]}/{$this->params[1]}/default");
        ...
        //        $this->sendTerminal(' - $this->core->request->defaultServiceUrl(\'/_version\') ->' . $this->core->request->defaultServiceUrl('/_version'));
        //        $this->sendTerminal(' - $this->core->request->get_json_decode(\'/_version\') ->'."\n----");
        //        $ret = $this->core->request->get_json_decode('/_version?__p');
        //        $this->sendTerminal($this->core->jsonEncode($ret,JSON_PRETTY_PRINT)."\n----");
        /*
